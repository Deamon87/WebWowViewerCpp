...
#ifndef WOWMAPVIEWERREVIVED_FIRSTPERSONORTHOTOPDOWNCAMERA_H
#define WOWMAPVIEWERREVIVED_FIRSTPERSONORTHOTOPDOWNCAMERA_H
...
class FirstPersonOrthoStaticTopDownCamera: public ICamera {
public:
    FirstPersonOrthoStaticTopDownCamera(){};
...
#endif //WOWMAPVIEWERREVIVED_FIRSTPERSONORTHOTOPDOWNCAMERA_H
