...
{
  return this->m_materials.m_currentLength;
}
...
unsigned int __cdecl CRibbonEmitter::InterpEdge(float age, float t, unsigned int advance)
{
  ...
  int v20; // ebx
  int v21; // eax
  CRibbonVertex *v22; // [esp+2Ch] [ebp-2Ch]
  char *v23; // [esp+30h] [ebp-28h]
  unsigned int v24; // [esp+34h] [ebp-24h]
  unsigned int v25; // [esp+38h] [ebp-20h]
  unsigned int v26; // [esp+3Ch] [ebp-1Ch]

  v4 = 2 * this->m_writePos;
  v23 = (char *)&this->m_gxVertices;
  v26 = this->m_gxVertices.size();
  v5 = v4;
  assert(2 * this->m_writePos < this->m_gxVertices.size());

  v22 = &this->m_gxVertices.m_elementPointer[2 * this->m_writePos];
  v6 = 2 * this->m_writePos + 1;
  assert(2 * this->m_writePos + 1 < this->m_gxVertices.size());


  auto v7 = &this->m_gxVertices[v6];
  v8 = 1.0 - t;
  
  v22->pos = ((this->m_below1 - ((1.0f - t) * this->m_currDirScaled)) * t)
             + (((t * this->m_prevDirScaled) + this->m_below0) * (1.0f - t));

  v7->pos = ((this->m_above1 - ((1.0f - t) * this->m_currDirScaled)) * t)
...
//----- (00A1AD60) --------------------------------------------------------
__int32 __usercall CRibbonEmitter::Update(int a1, float deltaTime, int suppressNewEdges)
{
  float v4; // xmm0_4
  unsigned int v5; // esi
  unsigned int v6; // eax
  ...
  if ( !(this->m_ribbonEmitterflags & m_singletonUpdated) )
  {
    ...
    if ( this->m_edgesPerSec > 0.0 )
      deltaTime = (float)(1.0 / this->m_edgesPerSec) + 0.000099999997;
  }
  if ( deltaTime >= 0.0 )
  {
...
LABEL_10:
  ...
  {
    v83 = this->m_edges.m_currentLength;
    if ( v5 >= v83 )
    {
      a1 = (*(int (__cdecl **)(char *))(this->m_edges.vTable + 4))(v66);
      v28 = (*(int (__cdecl **)(char *))this->m_edges.vTable)(v66);
      SErrDisplayErrorFmt(-2062548864, v28, a1, 1, 1, "index (0x%08X), array size (0x%08X)", v5, v83);
    }
    if ( (float)(deltaTime + this->m_edges.m_elementPointer[v5]) <= this->m_edgeLifeSpan )
      break;
    if ( !this->m_edges.m_currentLength )
      SErrDisplayError(
        -2062548992,
    ...
    v5 = this->m_readPos + 1;
    this->m_readPos = v5;
    v6 = this->m_edges.m_currentLength;
    if ( v5 < v6 )
  ...
  if ( !suppressNewEdges
    && (this->m_ribbonEmitterflags & (m_userEnabled|m_dataEnabled|m_posSet)) == (m_userEnabled|m_dataEnabled|m_posSet) )
  {
    v76 = (float)(deltaTime * this->m_edgesPerSec) + this->m_startTime;
    if ( *(_DWORD *)&g_theGxDevicePtr->gapA4[20] == 1 )
    {
      v65 = (CImVector)(((unsigned __int8)this->m_diffuseClr.b << 16) | ((unsigned __int8)this->m_diffuseClr.a << 24) | (unsigned __int16)a1);
      v65.g = this->m_diffuseClr.g;
      v65.b = this->m_diffuseClr.r;
      v38 = v65;
    }
    else
    {
      v38 = this->m_diffuseClr;
    }
    v95 = v38;
    CRibbonEmitter::InitInterpDeltas(this);
    if ( v76 < 1.0 )
      goto LABEL_88;
    v94 = this->m_startTime;
    v78 = 1.0 / (float)(v76 - v94);
    v39 = floorf(v76 - 1.0f);
...
LABEL_88:
    ...
    else
    {
      ...
      {
        v73 = this->m_writePos;
        v84 = this->m_gxVertices.m_currentLength;
        if ( 2 * v73 >= v84 )
        {
          v46 = (*(int (__cdecl **)(char *))(this->m_gxVertices.vTable + 4))(v69);
          v47 = (*(int (__cdecl **)(char *))this->m_gxVertices.vTable)(v69);
          SErrDisplayErrorFmt(-2062548864, v47, v46, 1, 1, "index (0x%08X), array size (0x%08X)", 2 * v73, v84);
        }
        this->m_gxVertices.m_elementPointer[2 * v73].diffuseColor = v95;
        v45 = 2 * this->m_writePos + 1;
        v85 = this->m_gxVertices.m_currentLength;
        if ( v45 >= v85 )
        {
          v48 = (*(int (__cdecl **)(char *))(this->m_gxVertices.vTable + 4))(v69);
          v49 = (*(int (__cdecl **)(char *))this->m_gxVertices.vTable)(v69);
          SErrDisplayErrorFmt(-2062548864, v49, v48, 1, 1, "index (0x%08X), array size (0x%08X)", v45, v85);
        }
        this->m_gxVertices.m_elementPointer[v45].diffuseColor = v95;
        CRibbonEmitter::InterpEdge(
          this,
          (float)((float)(i - v94) * v78) * COERCE_FLOAT(LODWORD(deltaTime) ^ xmmword_10131A0),
          (float)(i - v94) * v78,
          1u);
        if ( --v79 == -1 )
          break;
    ...
    CRibbonEmitter::InterpEdge(this, 0.0, 1.0, 0);
    v72 = this->m_writePos;
    v86 = this->m_gxVertices.m_currentLength;
    if ( 2 * v72 >= v86 )
    {
      v57 = (*(int (__cdecl **)(char *))(this->m_gxVertices.vTable + 4))(v69);
      v58 = (*(int (__cdecl **)(char *))this->m_gxVertices.vTable)(v69);
      SErrDisplayErrorFmt(-2062548864, v58, v57, 1, 1, "index (0x%08X), array size (0x%08X)", 2 * v72, v86);
    }
    v51 = &this->m_gxVertices.m_elementPointer[2 * v72];
    v52 = this->m_texSlotBox.minx;
    v51->texCoord.y = this->m_texSlotBox.miny;
    v51->texCoord.x = v52;
    v53 = 2 * this->m_writePos + 1;
    v87 = this->m_gxVertices.m_currentLength;
    if ( v53 >= v87 )
    {
      v63 = (*(int (__cdecl **)(char *))(this->m_gxVertices.vTable + 4))(v69);
      v64 = (*(int (__cdecl **)(char *))this->m_gxVertices.vTable)(v69);
      SErrDisplayErrorFmt(-2062548864, v64, v63, 1, 1, "index (0x%08X), array size (0x%08X)", v53, v87);
    }
    v54 = &this->m_gxVertices.m_elementPointer[v53];
    v55 = this->m_texSlotBox.minx;
    v54->texCoord.y = this->m_texSlotBox.maxy;
    v54->texCoord.x = v55;
    v71 = this->m_writePos;
    v88 = this->m_gxVertices.m_currentLength;
    if ( 2 * v71 >= v88 )
    {
      v61 = (*(int (__cdecl **)(char *))(this->m_gxVertices.vTable + 4))(v69);
      v62 = (*(int (__cdecl **)(char *))this->m_gxVertices.vTable)(v69);
      SErrDisplayErrorFmt(-2062548864, v62, v61, 1, 1, "index (0x%08X), array size (0x%08X)", 2 * v71, v88);
    }
    this->m_gxVertices.m_elementPointer[2 * v71].diffuseColor = v95;
    v56 = 2 * this->m_writePos + 1;
    v89 = this->m_gxVertices.m_currentLength;
    if ( v56 >= v89 )
    {
      v59 = (*(int (__cdecl **)(char *))(this->m_gxVertices.vTable + 4))(v69);
      v60 = (*(int (__cdecl **)(char *))this->m_gxVertices.vTable)(v69);
      SErrDisplayErrorFmt(-2062548864, v60, v59, 1, 1, "index (0x%08X), array size (0x%08X)", v56, v89);
    }
    this->m_gxVertices.m_elementPointer[v56].diffuseColor = v95;
  }
  this->m_minWorldBounds.z = 3.4028235e38;
  this->m_minWorldBounds.y = 3.4028235e38;
  this->m_minWorldBounds.x = 3.4028235e38;
  this->m_maxWorldBound.z = -3.4028235e38;
  this->m_maxWorldBound.y = -3.4028235e38;
  this->m_maxWorldBound.x = -3.4028235e38;
  v80 = this->m_readPos;
  ...
  {
    v25 = 2 * j;
    v93 = this->m_gxVertices.m_currentLength;
    if ( 2 * j >= v93 )
    {
      v26 = (*(int (__cdecl **)(char *))(this->m_gxVertices.vTable + 4))(v68);
      v27 = (*(int (__cdecl **)(char *))this->m_gxVertices.vTable)(v68);
      SErrDisplayErrorFmt(-2062548864, v27, v26, 1, 1, "index (0x%08X), array size (0x%08X)", v25, v93);
      v93 = this->m_gxVertices.m_currentLength;
    }
    v8 = this->m_gxVertices.m_elementPointer;
    v70 = v80;
    v82 = (CRibbonVertex *)((char *)v8 + 8 * (v25 + 4 * v80));
    v9 = v25 + 1;
    if ( v9 >= v93 )
    {
      v33 = (*(int (__cdecl **)(char *))(this->m_gxVertices.vTable + 4))(v68);
      v34 = (*(int (__cdecl **)(char *))this->m_gxVertices.vTable)(v68);
      SErrDisplayErrorFmt(-2062548864, v34, v33, 1, 1, "index (0x%08X), array size (0x%08X)", v9, v93);
      v8 = this->m_gxVertices.m_elementPointer;
    }
    v10 = &v8[v9];
    v11 = this->m_gravity;
    v74 = this->m_gravity;
    v90 = this->m_edges.m_currentLength;
    if ( v80 >= v90 )
    {
      v35 = (*(int (__cdecl **)(char *))(this->m_edges.vTable + 4))(v67);
      v36 = (*(int (__cdecl **)(char *))this->m_edges.vTable)(v67);
      SErrDisplayErrorFmt(-2062548864, v36, v35, 1, 1, "index (0x%08X), array size (0x%08X)", v80, v90);
      v11 = v74;
    }
    v12 = (float)((float)((float)(v11 + v11) * this->m_edges.m_elementPointer[v70]) * deltaTime)
    ...
    v91 = this->m_edges.m_currentLength;
    if ( v80 >= v91 )
    {
      v31 = (*(int (__cdecl **)(char *))(this->m_edges.vTable + 4))(v67);
      v32 = (*(int (__cdecl **)(char *))this->m_edges.vTable)(v67);
      SErrDisplayErrorFmt(-2062548864, v32, v31, 1, 1, "index (0x%08X), array size (0x%08X)", v80, v91);
    }
    this->m_edges.m_elementPointer[v70] = deltaTime + this->m_edges.m_elementPointer[v70];
    v22 = this->m_tmpDU;
    v75 = this->m_tmpDU;
    v92 = this->m_edges.m_currentLength;
    if ( v80 >= v92 )
    {
      v29 = (*(int (__cdecl **)(char *))(this->m_edges.vTable + 4))(v67);
      v30 = (*(int (__cdecl **)(char *))this->m_edges.vTable)(v67);
      SErrDisplayErrorFmt(-2062548864, v30, v29, 1, 1, "index (0x%08X), array size (0x%08X)", v80, v92);
      v22 = v75;
    }
    v23 = (float)((float)(v22 * this->m_edges.m_elementPointer[v70]) * *(float *)&this->m_ooLifeSpan)
        + this->m_texSlotBox.minx;
  ...
  result = (this->m_ribbonEmitterflags | m_singletonUpdated) & ~0x20;
  this->m_ribbonEmitterflags = result;
  return result;
}
// 10131A0: using guessed type __int128 xmmword_10131A0;

//----- (00A1B990) --------------------------------------------------------
CTexture *__cdecl CRibbonEmitter::CloseTextureHandles(CRibbonEmitter *this)
{

}

//----- (00A1BAE0) --------------------------------------------------------
float CRibbonEmitter::~CRibbonEmitter(CRibbonEmitter *this)
{
...
signed int CRibbonEmitter::Initialize(float edgesPerSec, float edgeLifeSpanInSec, CImVector diffuseColor, TSGrowableArray_CTexture *textures, TSGrowableArray *materials, TSGrowableArray_unsigned_int *replaces, CRect *a8, unsigned int rows, unsigned int cols)
{
  ...
  if ( edgeLifeSpanInSec <= 0.0 )
    SErrDisplayError(
      ...
      1,
      0);
  textures_Count = materials->m_currentLength;
  if ( textures_Count != textures->m_currentLength )
  {
    SErrDisplayError(
      -2062548992,
      (int)"/Users/patchman/buildserver/wow-b/work/WoW-code/branches/wow-patch-4_1_0-branch/WoW/Source/Mac/../../../Engin"
           "e/Source/Services/RibbonEmitter.cpp",
      238,
      "materials.Count() == textures.Count()",
      0,
      1,
      0);
    textures_Count = textures->m_currentLength;
  }
  if ( replaces->m_currentLength != textures_Count )
    SErrDisplayError(
      -2062548992,
      (int)"/Users/patchman/buildserver/wow-b/work/WoW-code/branches/wow-patch-4_1_0-branch/WoW/Source/Mac/../../../Engin"
           "e/Source/Services/RibbonEmitter.cpp",
      239,
      "textures.Count() == replaces.Count()",
      0,
      1,
      0);
...
LABEL_13:
  ...
  this->m_writePos = 0;
  this->m_startTime = 0.0;
  this->m_ribbonEmitterflags &= ~m_posSet;
  v17 = 2 * v16;
  v94 = 2 * v16;
...
LABEL_50:
  ...
  this->m_below = 10.0;
  this->m_gravity = 0.0;
  this->m_ribbonEmitterflags = v44 | m_userEnabled|m_dataEnabled|m_initialized;
  return result;
}
...
// 1215220: using guessed type _DWORD CRibbonEmitter::s_enableRibbonRendering;
// 1215224: using guessed type _DWORD CRibbonEmitter::s_enableFog;

//----- (00A1DB70) --------------------------------------------------------
CTexture **__cdecl CRibbonEmitter::SetTexture(unsigned int a2, CTexture *a3)
{
  unsigned int v3; // esi
  int v4; // ebx
  int v5; // eax
  ...
  if ( a3 )
    TextureAddRef(a3);
  v12 = (char *)&this->m_textures;
  v3 = this->m_textures.m_currentLength;
  if ( a2 >= v3 )
  {
    v7 = (*(int (__cdecl **)(TSGrowableArray_CTexture *))(this->m_textures.vTable + 4))(&this->m_textures);
    v8 = (*(int (__cdecl **)(char *))this->m_textures.vTable)(v12);
    SErrDisplayErrorFmt(-2062548864, v8, v7, 1, 1, "index (0x%08X), array size (0x%08X)", a2, v3);
    v3 = this->m_textures.m_currentLength;
  }
  v11 = a2;
  if ( this->m_textures.m_elementPointer[a2] )
  {
    if ( a2 >= v3 )
    {
      v9 = (*(int (__cdecl **)(char *))(this->m_textures.vTable + 4))(v12);
      v10 = (*(int (__cdecl **)(char *))this->m_textures.vTable)(v12);
      SErrDisplayErrorFmt(-2062548864, v10, v9, 1, 1, "index (0x%08X), array size (0x%08X)", a2, v3);
    }
    TextureRelease(&this->m_textures.m_elementPointer[v11]);
    v3 = this->m_textures.m_currentLength;
  }
  if ( a2 >= v3 )
  {
    v4 = (*(int (__cdecl **)(char *))(this->m_textures.vTable + 4))(v12);
    v5 = (*(int (__cdecl **)(char *))this->m_textures.vTable)(v12);
    SErrDisplayErrorFmt(-2062548864, v5, v4, 1, 1, "index (0x%08X), array size (0x%08X)", a2, v3);
  }
  result = this->m_textures.m_elementPointer;
  result[v11] = a3;
  return result;
}

//----- (00A1DD10) --------------------------------------------------------
int __cdecl CRibbonEmitter::ReplaceTexture(unsigned int a2, CTexture *a3)
{
  unsigned int v3; // esi
  int v5; // ebx
  int v6; // eax
  ...
  v13 = 0;
  if ( this->m_replaces.m_currentLength )
  {
    v12 = 0;
    v14 = 0;
    v11 = (char *)&this->m_textures;
    do
    {
      if ( this->m_replaces.m_elementPointer[v14] == a2 )
      {
        if ( a3 )
          TextureAddRef(a3);
        v3 = this->m_textures.m_currentLength;
        if ( v3 <= v12 )
        {
          v5 = (*(int (__cdecl **)(char *))(this->m_textures.vTable + 4))(v11);
          v6 = (*(int (__cdecl **)(char *))this->m_textures.vTable)(v11);
          SErrDisplayErrorFmt(-2062548864, v6, v5, 1, 1, "index (0x%08X), array size (0x%08X)", v12, v3);
          v3 = this->m_textures.m_currentLength;
        }
        if ( this->m_textures.m_elementPointer[v14] )
        {
          if ( v12 >= v3 )
          {
            v9 = (*(int (__cdecl **)(char *))(this->m_textures.vTable + 4))(v11);
            v10 = (*(int (__cdecl **)(char *))this->m_textures.vTable)(v11);
            SErrDisplayErrorFmt(-2062548864, v10, v9, 1, 1, "index (0x%08X), array size (0x%08X)", v12, v3);
          }
          TextureRelease(&this->m_textures.m_elementPointer[v14]);
          v3 = this->m_textures.m_currentLength;
        }
        if ( v12 >= v3 )
        {
          v7 = (*(int (__cdecl **)(char *))(this->m_textures.vTable + 4))(v11);
          v8 = (*(int (__cdecl **)(char *))this->m_textures.vTable)(v11);
          SErrDisplayErrorFmt(-2062548864, v8, v7, 1, 1, "index (0x%08X), array size (0x%08X)", v12, v3);
        }
        this->m_textures.m_elementPointer[v14] = a3;
        ++v13;
      }
      ++v12;
      ++v14;
    }
    while ( this->m_replaces.m_currentLength > v12 );
  }
  return v13;
}