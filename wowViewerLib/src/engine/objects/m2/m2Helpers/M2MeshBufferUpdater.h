...
public:
    ...
    static void updateMaterialData(const std::shared_ptr<IM2Material> &m2Material, M2Object *m2Object, M2SkinProfile * m2SkinProfile);
    static void updateProjectiveMaterialData(int batchIndex, uint8_t blendMode, uint8_t vertexIndex, uint8_t pixelShader,
        const std::shared_ptr<IM2ProjectiveMaterial> &m2Material, M2Object *m2Object, const M2Data * m2Data, M2SkinProfile * m2SkinProfile);

    static mathfu::mat4 getTextureMatrix(const M2Object &m2Object, int textureMatIndex, const M2Data *m2Data);

    static void getTextureMatrixIndexes(const M2Object &m2Object, int batchIndex, uint8_t vertexIndex,
                                        const M2Data *m2Data, const M2SkinProfile *m2SkinProfile,
                                        std::array<int, 2> &o_textureMatIndexes);
    ...
    static float getTextureWeight(const M2SkinProfile *skinData, const M2Data *m2data, int batchIndex, int textureIndex, const std::vector<float> &transparencies) ;

    static void fillTextureMatrices(const M2Object &m2Object, int batchIndex, uint8_t vertexIndex, M2Data *m2Data,
