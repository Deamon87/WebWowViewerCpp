...
const  std::unordered_map<std::string, std::unordered_map<int, std::vector<fieldDefine>>> fieldDefMapPerShaderName = {
  ...
  {"waterfallShader",  {
    ...
    {
      4, {
        {"_216.values0", true, 0, 1, 4, 0},
        {"_216.values1", true, 16, 1, 4, 0},
        {"_216.values2", true, 32, 1, 4, 0},
        {"_216.values3", true, 48, 1, 4, 0},
        {"_216.values4", true, 64, 1, 4, 0},
        {"_216.baseColor", true, 80, 1, 4, 0},
      }
    },
  }},
  {"drawDepthShader",  {
