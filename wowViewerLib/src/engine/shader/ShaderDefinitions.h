  ...
  {"skyConus",  {
    ...
    },
    {
      0, {
        ...
        {"_26.fogData.densityParams", true, 240, 1, 4, 0},
        {"_26.fogData.heightPlane", true, 256, 1, 4, 0},
        {"_26.fogData.color_and_heightRate", true, 272, 1, 4, 0},
        {"_26.fogData.heightDensity_and_endColor", true, 288, 1, 4, 0},
        {"_26.fogData.sunAngle_and_sunColor", true, 304, 1, 4, 0},
        {"_26.fogData.heightColor_and_endFogDistance", true, 320, 1, 4, 0},
        {"_26.fogData.sunPercentage", true, 336, 1, 4, 0},
      }
    },
  }},
  {"m2Shader",  {
  ...
  {"m2Shader_pbr",  {
    ...
    },
    {
      0, {
        ...
        {"_510.fogData.densityParams", true, 240, 1, 4, 0},
        {"_510.fogData.heightPlane", true, 256, 1, 4, 0},
        {"_510.fogData.color_and_heightRate", true, 272, 1, 4, 0},
        {"_510.fogData.heightDensity_and_endColor", true, 288, 1, 4, 0},
        {"_510.fogData.sunAngle_and_sunColor", true, 304, 1, 4, 0},
        {"_510.fogData.heightColor_and_endFogDistance", true, 320, 1, 4, 0},
        {"_510.fogData.sunPercentage", true, 336, 1, 4, 0},
      }
    },
    {
      4, {
