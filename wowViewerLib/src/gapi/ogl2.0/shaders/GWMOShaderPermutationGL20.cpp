...
#include "GWMOShaderPermutationGL20.h"


GWMOShaderPermutationGL20::GWMOShaderPermutationGL20(std::string &shaderName, IDevice *device, WMOShaderCacheRecord &permutation) :
            GShaderPermutationGL20(shaderName,device), permutation(permutation) {}

void GWMOShaderPermutationGL20::compileShader(const std::string &vertExtraDefStrings, const std::string &fragExtraDefStrings) {
