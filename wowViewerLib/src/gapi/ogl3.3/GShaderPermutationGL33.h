...
protected:
    explicit GShaderPermutationGL33(std::string &shaderName, const HGDevice &device);
    explicit GShaderPermutationGL33(std::string &shaderNameVert, std::string &shaderNameFrag, const HGDevice &device);
