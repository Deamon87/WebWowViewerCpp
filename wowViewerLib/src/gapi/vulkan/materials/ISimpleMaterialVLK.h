...
public:
    ISimpleMaterialVLK(const HGDeviceVLK &device, std::string vertexShader, std::string pixelShader, std::vector<std::shared_ptr<IBufferVLK>> &ubos, std::vector<std::shared_ptr<GTextureVLK>> &textures);
