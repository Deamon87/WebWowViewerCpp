...
//    }
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        auto vboBuffer = renderer->createVertexBuffer(cmd_list->VtxBuffer.Size * sizeof(ImDrawVert));
        auto iboBuffer = renderer->createIndexBuffer(cmd_list->IdxBuffer.Size * sizeof(ImDrawIdx));

        auto vertexBufferBindings = renderer->createVAO(vboBuffer, iboBuffer);
